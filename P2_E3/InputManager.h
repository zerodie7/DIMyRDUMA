...
public:
	...
	InputManager() :
		lastMousePos(glm::ivec2(0.0)), deltax(0), deltay(0), scrollYoffset(2),
		cameraPos(glm::vec3(0.0f, 0.0f, 10.0f)), yaw(0), pitch(20), roll(0), distanceFromPlayer(5), angleAroundPlayer(0), initDir(false) {
